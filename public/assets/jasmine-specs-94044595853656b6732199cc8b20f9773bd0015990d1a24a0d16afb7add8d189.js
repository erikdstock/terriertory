...
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/dashboard_dogs"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class = "row">\n  <div class = "small-centered columns">\n    <h3>My Dogs</h3>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/dashboard_neighbors"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class = "row">\n  <div class = "small-centered columns">\n    <h3>My Neighbors</h3>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/dog_button"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class = "row">\n  <div class = "small-centered columns ">\n    <a class=\'button small expand radius small-12 \'>****',  name ,' ',  breed ,' - ',  distanceTraveled ,' miles - ',  distanceScore ,' pts </a>\n  </div>\n  <div class = "dog-details" style = "display:none">\n    HELLO PUPPIES\n    ',  name ,' - ',  breed ,' - ',  distanceTraveled ,' - ',  distanceScore,'\n    ',  distanceTraveled ,'\n    ',  "avatar file name!" + avatar_file_name ,'\n    <img src="', avatar_file_name,'">\n\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
...
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/neighbor_button"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class = "row">\n  <div class = "small-centered columns ">\n    <a class=\'button small expand radius small-12 Primary\'>',  username ,' - ',  distanceTraveled ,' miles - ',  distanceScore ,' pts </a>\n  </div>\n  <div class = "neighbor-details" style = "display:none">\n    HELLO NEIGHBOR !\n    ',  username ,'\n    ',  "avatar file name!" + avatar_file_name   ,'\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["backbone/templates/no_dogs"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div data-alert class=\'alert-box warning radius\' >\n    You haven\'t added any dogs yet!<a href="#" class="close">&times;</a>\n</div>\n');}return __p.join('');};
}).call(this);
